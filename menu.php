    ...
    <div id="sidebar-scroll">
        ...
        <div class="sidebar-content">
            ...
            <ul class="sidebar-nav">
                <li>
                    <a href="../pilihan.php" class="<?php if($_SESSION['aktif'] == 'dashboard'){echo "active";} ?>"><i class="gi gi-compass sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Dashboard</span></a>
                </li>
                <li class="sidebar-separator">
                    <i class="fa fa-ellipsis-h"></i>
                </li>

                <li class="<?php if($_SESSION['aktif'] == 'klasifikasi' or $_SESSION['aktif'] == 'agama' or $_SESSION['aktif'] == 'dokumen'){echo "active";} ?>">
                    ...
                    <ul>
                        <li >
                            <a href='../pilihan.php?menu=1' class="<?php if($_SESSION['aktif'] == 'agama'){echo " active";} ?>">
                                <i class="fa fa-list sidebar-nav-icon"></i> Agama
                            </a>
                        </li>
                        <li >
                            <a href='../pilihan.php?menu=2' class="<?php if($_SESSION['aktif'] == 'dokumen'){echo " active";} ?>">
                                <i class="fa fa-folder sidebar-nav-icon"></i> Dokumen
                            </a>
                        </li>
                        <li >
                            <a href='../pilihan.php?menu=3' class="<?php if($_SESSION['aktif'] == 'klasifikasi'){echo " active";} ?>">
                ...
                <li class="<?php if($_SESSION['aktif'] == 'penduduk' or $_SESSION['aktif'] == 'kk' or $_SESSION['aktif'] == 'laporan'){echo "active";} ?>">
                    ...
                    <ul>
                        <li >
                            <a href="../pilihan.php?menu=4" class="<?php if($_SESSION['aktif'] == 'kk'){echo " active";} ?>">
                                <i class="fa fa-cubes sidebar-nav-icon"></i> Kartu Keluarga
                            </a>
                        </li>

                        <li >
                            <a href="../pilihan.php?menu=5" class="<?php if($_SESSION['aktif'] == 'penduduk'){echo " active";} ?>">
                                <i class="fa fa-user sidebar-nav-icon"></i> Data Penduduk
                            </a>
                        </li>
                        <li >
                            <a href="../pilihan.php?menu=8" class="<?php if($_SESSION['aktif'] == 'laporan'){echo " active";} ?>">
                ...
                <li>
                    <a href="../pilihan.php?menu=6" class="<?php if($_SESSION['aktif'] == 'chat'){echo "active";} ?>"><i class="fa fa-share-alt sidebar-nav-icon">
