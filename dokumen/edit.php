                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            ...
                                            <li><a href="../pilihan.php?menu=2">DOKUMEN</a></li>
                                            <li>EDIT</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="block">
                            ...
                            <form action="edit.php?id<?php echo $edit['id_dokumen']; ?>" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
                                    <input type="hidden" name="id_dokumen" value="<?php echo $edit['id_dokumen']; ?>">
                                    <label class="col-md-3">Nama Dokumen</label>
                                    <div class="col-md-8">
                                        <input type="text" name="nama_dokumen" class="form-control" placeholder="Nama dokumen" value="<?php echo $edit['nama_dokumen'] ?>">
                                    </div>
                                </div>
