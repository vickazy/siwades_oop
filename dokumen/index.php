...
$_SESSION['aktif'] = 'dokumen';
$menu = "../menu.php";
$profil = "../profil.php";
$title = "DOKUMEN || SIWADES";
 ?>
                                    ...
                                    <?php $no=0; foreach ($dokumen as $row): $no++?>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                $jum = $_mysqli->query("SELECT penduduk.nama FROM penduduk, file, dokumen 
                                                                        WHERE dokumen.id_dokumen = '$id_dok' 
                                                                        AND penduduk.nik = file.nik
                                                                        AND dokumen.id_dokumen = file.id_dokumen");
                                                $jumlah = mysqli_num_rows($jum);
                                             ?>
                                            <td><span class="label label-info"><?php echo $jumlah." ".$row['nama_dokumen']; ?></span></td>
                                            <?php
                                                include('../koneksi.php');
                                                $id_d = $row['id_dokumen'];
                                                $jum2 = $_mysqli->query("SELECT penduduk.nama FROM penduduk,klasifikasi,dokumen,klasifikasi_dokumen 
                                                                        ...
                                                                        AND dokumen.id_dokumen = '$id_d'");
                                                $jumlah2 = mysqli_num_rows($jum2);
                                             ?>
                                            <td><span class="label label-danger"><?php echo $jumlah2." Orang"; ?></span></td>
                                            <td class="text-center">
                                                <a href="edit.php?edit=<?php echo $row['id_dokumen']; ?>" data-toggle="tooltip" title="Edit <?php echo $row['nama_dokumen']?>" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                                <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row['nama_dokumen'] ?> ?');" href="?hapus=<?php echo $row['id_dokumen']; ?>" data-toggle="tooltip" title="Delete <?php echo $row['nama_dokumen']?>" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
